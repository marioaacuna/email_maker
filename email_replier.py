...
def generate_response():
    ...
    prompt = f'Given the format """ {email_format} """, respond to the following email sent to me: """ EMAIL: {email_content}""". The response needs to include the following: """{what_to}""". Sign as """ Mario""" '
